...
#downloadList=("evhands" "f-event" "f-rgb" "p-full" "p-full-lr3-nodecay-evreal")
#weightList=("checkpoint-150-4200" "checkpoint-300-27300" "checkpoint-300-27300" "checkpoint-150-27300" "checkpoint-300-19200")
